  ...
  return (
    <div className="h-full w-[50vw] px-9 flex items-center">
      <div className="grid grid-cols-2 gap-4 w-full h-2/3 items-center justify-items-center">
        ...
        <ActionBox label="Terminal" icon={Terminal} color="bg-gray-900" />
        <ActionBox label="Preheat" icon={Flame} color="bg-orange-500" />
        <ActionBox label="Settings" icon={Settings} color="bg-gray-500" />
        <ActionBox label="Print" icon={Printer} className="col-span-2" />
      </div>
    </div>
  );
}
